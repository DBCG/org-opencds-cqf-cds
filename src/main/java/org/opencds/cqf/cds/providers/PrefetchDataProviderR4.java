        ...
        for (Object resource : resourcesOfType) {
            ...
            if (dateRange != null) {
                if (datePath != null) {
                    ...
                    Object dateObject = PrefetchDataProviderHelper
                            .getR4DateTime(this.resolver.resolvePath(resource, datePath));
                    ...
                    DateTime lowDate = dateLowPath == null ? null
                            : (DateTime) PrefetchDataProviderHelper
                                    .getR4DateTime(this.resolver.resolvePath(resource, dateLowPath));
                    DateTime highDate = dateHighPath == null ? null
                            : (DateTime) PrefetchDataProviderHelper
                                    .getR4DateTime(this.resolver.resolvePath(resource, dateHighPath));
            ...
            if (codePath != null && !codePath.equals("") && includeResource) {
                ...
                if (codes != null) {
                    ...
                    includeResource = PrefetchDataProviderHelper.checkCodeMembership(codes, codeObject, FhirVersionEnum.R4);
                }
            }
