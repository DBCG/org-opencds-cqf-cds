...
public class PrefetchDataProviderStu3 extends TerminologyAwareRetrieveProvider {
    ...
    public PrefetchDataProviderStu3(List<Object> resources, ModelResolver modelResolver) {
        prefetchResources = PrefetchDataProviderHelper.populateMap(resources);
        this.resolver = modelResolver;
        this.codeUtil = new CodeUtil(FhirContext.forCached(FhirVersionEnum.DSTU3));
    }
            ...
            if (dateRange != null) {
                if (datePath != null) {
                    ...
                    Object dateObject = PrefetchDataProviderHelper
                            .getStu3DateTime(this.resolver.resolvePath(resource, datePath));
                    ...
                    DateTime lowDate = dateLowPath == null ? null
                            : (DateTime) PrefetchDataProviderHelper
                                    .getStu3DateTime(this.resolver.resolvePath(resource, dateLowPath));
                    DateTime highDate = dateHighPath == null ? null
                            : (DateTime) PrefetchDataProviderHelper
                                    .getStu3DateTime(this.resolver.resolvePath(resource, dateHighPath));
